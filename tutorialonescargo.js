 ...
 * -----
 *
 * tutorialonescargo.js
 *
 * TutorialOneScargo user interface script
 * 
...
function (dojo, declare) {
    return declare("bgagame.tutorialonescargo", ebg.core.gamegui, {
        constructor: function(){
            console.log('tutorialonescargo constructor');
...
*/
        ...
        */
        ...
        onMyMethodToCall1: function( evt )
        {
            ...
            this.ajaxcall( "/tutorialonescargo/tutorialonescargo/myAction.html", { 
                                                                    lock: true, 
                                                                    myArgument1: arg1, 
                                                                    myArgument2: arg2,
                                                                    ...
        ...
        */
        ...
        onPlayDisc: function( evt )
        {
            ...
            {
                this.ajaxcall( "/tutorialonescargo/tutorialonescargo/playDisc.html", {
                    x:x,
                    y:y
                }, this, function( result ) {} );
            }
        ...
        /*
            ...
            Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                  your tutorialonescargo.game.php file.
